...
;
; Destruye el valor de los registros A, DE y HL
; -----------------------------------------------------------------------------
AnimeCrashShip:
...
AnimeCrashShip_loop:
	...
	; Pone el carácter dónde se ha pintado la explosión en rojo
	LD A, 2
	CALL SetInkLR
...
PaintShip:
	...
	; Pone el carácter dónde se ha pintado la nave en blanco
	LD A, 7
	CALL SetInkLR
